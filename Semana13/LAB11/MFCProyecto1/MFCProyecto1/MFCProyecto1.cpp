...
// MFCProyecto1.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMFCProyecto1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCProyecto1App

CMFCProyecto1App::CMFCProyecto1App()
{
...
// Único objeto CMFCProyecto1App

CMFCProyecto1App theApp;


// Inicialización de CMFCProyecto1App

BOOL CMFCProyecto1App::InitInstance()
{
