...
// AplicacionDemo.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAplicacionDemoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAplicacionDemoApp

CAplicacionDemoApp::CAplicacionDemoApp()
{
...
// Único objeto CAplicacionDemoApp

CAplicacionDemoApp theApp;


// Inicialización de CAplicacionDemoApp

BOOL CAplicacionDemoApp::InitInstance()
{
