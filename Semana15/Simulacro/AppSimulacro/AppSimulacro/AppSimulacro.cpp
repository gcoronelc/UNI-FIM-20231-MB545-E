...
// AppSimulacro.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAppSimulacroApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAppSimulacroApp

CAppSimulacroApp::CAppSimulacroApp()
{
...
// Único objeto CAppSimulacroApp

CAppSimulacroApp theApp;


// Inicialización de CAppSimulacroApp

BOOL CAppSimulacroApp::InitInstance()
{
